...
class ExerciseGlobalFragment : Fragment() {
    ...
    private fun initRecyclerExercises(){
        ...
        exerciseAdapter = ExerciseGlobalAdapter(
            {categoryModel:ExerciseModel-> downloadExercise(categoryModel)}
        )
    ...
    private fun downloadExercise(exerciseModel: ExerciseModel) {
        GlobalScope.launch {
    ...
    companion object {
        @JvmStatic
        fun newInstance() = ExerciseGlobalFragment()
    }
}