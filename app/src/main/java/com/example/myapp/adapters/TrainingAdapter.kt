...
class TrainingAdapter(private val deleteTraining:(LineWithExercises)->Unit,
                      private val editTraining:(LineWithExercises)->Unit,
                       private val trainingViewModel: TrainingViewModel) : RecyclerView.Adapter<TrainingAdapter.TrainingHolder>() {
    ...
    override fun onBindViewHolder(holder: TrainingHolder, position: Int) {
        holder.bind(differ.currentList[position], deleteTraining, editTraining)
    }
